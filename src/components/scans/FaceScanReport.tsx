  ...
  return (
    ...
    >
      <section className="relative min-h-[76dvh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[68dvh] max-w-md flex-col justify-end px-5 pb-7">
          <div className="rounded-[28px] border border-white/10 bg-black/65 p-5 shadow-2xl backdrop-blur-xl">
      ...
      <div className="mx-auto max-w-md space-y-4 px-5">
        <section className="rounded-[28px] border border-white/[0.08] bg-white/[0.045] p-5">
          <div className="flex items-center gap-2 text-neon">
            ...
            <h2 className="text-[10px] font-black uppercase tracking-[0.2em]">Your readout</h2>
          </div>
          <p className="mt-2 text-[11px] leading-relaxed text-white/45">
            Each score reflects what this photo shows. Open, even lighting and a neutral angle make
            future comparisons more consistent.
          </p>
