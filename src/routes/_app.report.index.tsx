...
export const Route = createFileRoute("/_app/report/")({
  ...
  errorComponent: () => <div className="p-6 text-sm text-muted-foreground">Couldn't load your report. Try again.</div>,
  ...
  return (
    <div className="px-5 pt-6 pb-8 animate-slide-up">
      <header className="flex items-center justify-between mb-5">
        ...
        <Link to="/report/history" className="size-9 rounded-full bg-surface grid place-items-center" aria-label="History"><History className="size-4" /></Link>
      </header>
      {isLoading || !data ? (
