    ...
    <div className="min-h-dvh bg-background flex flex-col">
      ...
      <div className="relative h-[42vh] min-h-[320px] bg-gradient-to-br from-neon/30 via-surface-2 to-background overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-0 p-5 flex items-center justify-between">
          ...
          <button className="size-10 rounded-full bg-black/40 backdrop-blur grid place-items-center">
            <Heart className="size-5" />
          </button>
        </div>
        <div className="absolute inset-0 grid place-items-center">
          <div className="size-20 rounded-full bg-neon text-neon-foreground grid place-items-center animate-pulse-glow">
      ...
      <div className="fixed bottom-0 inset-x-0 px-5 pb-8 pt-4 bg-gradient-to-t from-background via-background to-transparent">
        <button className="w-full h-14 rounded-full bg-neon text-neon-foreground font-semibold text-base glow-neon active:scale-[0.98] transition">
          Let's workout
        </button>
      </div>
    </div>
