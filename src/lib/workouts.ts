...
const ex = (
  id: string, name: string, sets: number, repsOrTime: { reps?: string; time?: string },
  rest: string, muscleGroup: string, difficulty: Difficulty, demoType = "generic"
...
export const workouts: Workout[] = [
  {
    ...
    category: "Strength",
    description: "Sculpt legs and glutes with a focused circuit hitting quads, hamstrings, and posterior chain.",
    duration: 30, calories: 280, difficulty: "Intermediate",
    ...
    exercises: [
      ...
      ex("rdl", "Romanian Deadlift", 3, { reps: "10" }, "75s", "Hamstrings", "Intermediate", "hinge"),
      ex("lunge", "Reverse Lunge", 3, { reps: "10/side" }, "45s", "Glutes", "Intermediate", "lunge"),
  ...
  },
  {
    ...
    duration: 45, calories: 320, difficulty: "Intermediate",
    ...
    exercises: [
      ...
      ex("incline-db", "Incline DB Press", 3, { reps: "10" }, "75s", "Upper chest", "Intermediate", "press"),
  ...
  },
  {
    ...
    duration: 45, calories: 310, difficulty: "Intermediate",
    equipment: ["gym", "dumbbells", "mixed"],
  ...
  },
  {
    ...
    duration: 20, calories: 240, difficulty: "Beginner",
  ...
  },
  {
    ...
    duration: 45, calories: 300, difficulty: "Intermediate",
    ...
    exercises: [
      ...
      ex("db-row", "Single-Arm DB Row", 4, { reps: "10/side" }, "60s", "Back", "Intermediate", "row"),
      ex("db-ohp", "DB Shoulder Press", 3, { reps: "10" }, "60s", "Shoulders", "Intermediate", "press"),
  ...
  },
  {
    ...
    duration: 20, calories: 130, difficulty: "Beginner",
    equipment: ["none", "dumbbells", "gym", "mixed"],
    targetMuscles: ["core"],
  ...
  },
  {
    ...
    duration: 30, calories: 380, difficulty: "Advanced",
    equipment: ["none", "dumbbells", "gym", "mixed"],
    ...
    exercises: [
      ...
      ex("kbs", "Kettlebell Swings", 5, { time: "30s" }, "30s", "Posterior", "Intermediate", "hinge"),
  ...
  },
  {
    ...
    duration: 20, calories: 70, difficulty: "Beginner",
    equipment: ["none", "dumbbells", "gym", "mixed"],
    ...
    recommendedForLevels: ["beginner", "intermediate", "advanced"],
    exercises: [
      ex("wgs", "World's Greatest Stretch", 2, { time: "60s/side" }, "20s", "Hips", "Beginner", "stretch"),
      ex("cc", "Cat-Cow", 2, { time: "60s" }, "20s", "Spine", "Beginner", "stretch"),
      ex("hipswitch", "90/90 Hip Switch", 2, { reps: "10/side" }, "20s", "Hips", "Beginner", "stretch"),
      ex("shoulder", "Shoulder Pass-Through", 2, { reps: "15" }, "20s", "Shoulders", "Beginner", "stretch"),
    ],
  },
  {
    id: "glute-builder",
    ...
    duration: 45, calories: 290, difficulty: "Intermediate",
    ...
    exercises: [
      ...
      ex("bss", "Bulgarian Split Squat", 3, { reps: "10/side" }, "75s", "Glutes", "Advanced", "lunge"),
      ex("rdl-g", "Romanian Deadlift", 4, { reps: "10" }, "75s", "Hamstrings", "Intermediate", "hinge"),
  ...
  },
  {
    ...
    duration: 60, calories: 410, difficulty: "Advanced",
    equipment: ["gym", "dumbbells", "mixed"],
    ...
    exercises: [
      ...
      ex("close-grip", "Close-Grip Bench", 3, { reps: "8" }, "75s", "Triceps", "Intermediate", "press"),
    ],
  },
  {
    ...
    duration: 20, calories: 160, difficulty: "Beginner",
    equipment: ["none", "dumbbells", "gym", "mixed"],
  ...
  },
  {
    ...
    duration: 45, calories: 420, difficulty: "Intermediate",
    equipment: ["none", "dumbbells", "gym", "mixed"],
    ...
    exercises: [
      ...
      ex("intervals", "Tempo Intervals", 6, { time: "3 min" }, "90s", "Cardio", "Intermediate", "run"),
      ex("cool", "Cool Down Walk", 1, { time: "5 min" }, "—", "Cardio", "Beginner", "run"),
    ],
  },
];

export const getWorkout = (id: string): Workout | undefined => workouts.find((w) => w.id === id);
...
function dayToWorkoutId(label: string, profile: Profile): string | null {
  ...
  const pick = (filterFn: (w: Workout) => boolean) =>
    available.find(filterFn)?.id ?? null;

  switch (label) {
    case "Push": return pick((w) => w.targetMuscles.includes("chest"));
    case "Pull": return pick((w) => w.targetMuscles.includes("back"));
    case "Legs": return pick((w) => w.targetMuscles.includes("legs") || w.targetMuscles.includes("glutes"));
    case "Upper": return pick((w) => w.id === "upper-body-strength" || w.targetMuscles.includes("chest"));
    case "Lower": return pick((w) => w.id === "lower-body-burn" || w.targetMuscles.includes("legs"));
    case "Full Body A": return pick((w) => w.id === "full-body-sweat" || w.id === "bodyweight-starter");
    case "Full Body B": return pick((w) => w.id === "dumbbell-builder" || w.id === "bodyweight-starter");
    case "Conditioning": return pick((w) => w.category === "HIIT" || w.category === "Cardio");
    case "Active Recovery": return pick((w) => w.category === "Mobility");
    default: return null;
  }
}
